...
public class LifeEditor : Editor
{
    ...
    private static readonly GUIContent _minLifeLabel = new GUIContent("Min Life", "Minimun of life the entity will have.");
	...
	public override void OnInspectorGUI()
    {
        ...
        EditorGUILayout.PropertyField(_minLife, _minLifeLabel);
