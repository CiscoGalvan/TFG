...
Para ello vamos a comenzar haciendo un recorrido por elementos generales relacionados con la inteligencia artificial y cómo se usan en videojuegos de plataformas en dos dimensiones, ya sea para crear un Non-Player Characters (NPC) o enemigos.
