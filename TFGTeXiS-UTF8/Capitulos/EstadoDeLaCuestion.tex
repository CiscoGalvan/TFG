...
En el ámbito de los videojuegos, la IA se ha hecho paso a base de demostrar su gran capacidad de adaptación a contextos diversos como la adaptación del Alien en Alien Isolation \comp{ref}, la manera en la que puede generar contenido procedural para juegos RogueLite como Hades(referencia) o ,por último, entrenar una IA para que se acerque lo máximo posible al comportamiento de un humano como en la serie Forza Motosport, usando redes neuronales.\\
\section{Tecnicas}
...
\comp{Aquí podría poner una imagen de un ejemplo} \\\\
Su facilidad para ser diseñados y testeados han hecho que los árboles de comportamiento se conviertan en una opción real para modelar IA en la industria del videojuego, con juegos como Bioshock (2K Games, 2007) y Halo 2 (Microsoft Game Studios, 2004) \comp{HALO: https://www.gamedeveloper.com/programming/gdc-2005-proceeding-handling-complexity-in-the-i-halo-2-i-ai
Bioshock:} como referencias en el uso de BTs.\\
Un ejemplo no tan conocido de uso de BTs en la industria del videojuego es Spore (2008, Maxis).\comp{REFERENCIAS}Spore es un videojuego en el que el jugador va a comenzar creando una célula y va encarnarla durante todo el proceso de su evolución hasta que esta se convierta en un ser mucho más complejo llegando incluso a construir una civilización muy avanzada. La inteligencia artificial de las entidades que nos rodean en este videojuego están fundamentadas en BTs.
...
A continuación se muestra un ejemplo de un BT sacado de las documentación que hay publicada del juego. \url{https://chrishecker.com/My_Liner_Notes_for_Spore/Spore_Behavior_Tree_Docs}
Tengo que hablar de que las opciones tienen prioridades: "the group
