...
La escalabildad  que ofrece GOAP es mayor a todas las técnicas vistas anteriormente.
...
\begin{figure}[t]
	...
	\label{fig:BH_Figure}
\end{figure}
Un aspecto a destacar de esta herramienta es que es totalmente gratuita, fue desarrollada por \textit{PadaOne Games}\footnote{\url{https://www.padaonegames.com/}}, empresa asociada a la Universidad Complutense de Madrid.\\
...
\end{figure}
\subsection{Decisión}
Tras el análisis de loas herramientas con capacidad para integrar comportamientos de inteligencia artificial, surgieron opciones relevantes que nos permiten la integración con Unity. Si bien esas herramientas son completamente válidas, se ha optado por la creación de una herramienta propia, partiendo desde cero. Esta decisión se fundamenta en la necesidad de personalización y control exhaustivo. Superando así las posibles limitaciones económicas de la investigación y las pisibles faltas de adecuación total con otras herramientas.
