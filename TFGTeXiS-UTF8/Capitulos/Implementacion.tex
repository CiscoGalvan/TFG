...
La clase \textit{Player Movement } sirve como controlador del jugador. Esta clase es la encargada de gestionar el input del jugador y acorde a este mover al jugador. Esta clase permite modificar ciertos valores como la velocidad de movimiento o la potencia de salto.
