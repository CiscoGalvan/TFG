...
\chapterquote{Cada vez que juegas, estás creando una nueva versión del juego.}{Jonathan Blow}
...
\begin{figure}[t]
	\centering
	\includegraphics[width=0.9\textwidth]{Imagenes/UMLSensor.png}
...
\begin{figure}[t]
\centering
\includegraphics[width=1.1\textwidth]{Imagenes/UMLAnimator.png}
